...
/*    $("#BrowseApprovedWorkOrder").css('display', 'none');*/
    ...
    if (selectedDataItems.length === 1 && selectedDataItems !== []) {
        ...
        FileNameApproved = selectedDataItems[0].UserDepartment + ".jpg";
...
function BrowseApprovedWorkOrder() {
    ...
    //if (FileNameApproved === "" && $("#workOrderFileApprovedhdn").val() === "") FileNameApproved = $("#workOrderFileApprovedhdn").val();
...
$(document).ready(function () {
    ...
    if ($("#workOrderFileApprovedhdn").val() !== undefined) {
         FileNameApproved = $("#workOrderFileApprovedhdn").val()+ ".jpg";
        $("#BrowseApprovedWorkOrder").css('display', 'block');
    }
...
function fillWorkOrderCombobox(reqID) {
    $.ajax({
        type: "POST",
        url: '/WorkOrder/GetWorkOrderApprovalListByRequestID',
        data: {
            RequestId: reqID
        },
        error: function (result) {
